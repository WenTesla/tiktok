...
VALUES (1, 1, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/36924f94fdf64cb3e3cfca3956fa6d9c.mp4',
        ...
        '2023-02-02 19:49:36');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
VALUES (2, 2, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/664bc4e86cfae46338056e7ec016555e.mp4',
        'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/664bc4e86cfae46338056e7ec016555e.jpg', 'test',
        '2023-02-02 19:50:58');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
VALUES (3, 3, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/aefa322953ccc87ffe59525ad1b4e1c0.mp4',
        'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/aefa322953ccc87ffe59525ad1b4e1c0.jpg', 'test',
        '2023-02-02 19:51:42');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
VALUES (4, 4, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/b31512aa2916f3ab484f8a4be569a0fa.mp4',
        'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/b31512aa2916f3ab484f8a4be569a0fa.jpg', 'test',
        '2023-02-02 19:51:49');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
VALUES (5, 5, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/a1da2b17a124aa88d0134d75d3983b5f.mp4',
        'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/a1da2b17a124aa88d0134d75d3983b5f.jpg', 'test',
        '2023-02-02 19:51:56');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
VALUES (6, 2, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/dad18708c59804da1f3abb996cb56770.mp4',
...
VALUES (8, 2, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/bea309f6840bee5d95c233616b3f1f34.mp4',
        ...
        '2023-02-02 19:52:09');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
VALUES (9, 3, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/dbd19a6cba6bcf02027613b4caefdce8.mp4',
        'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/dbd19a6cba6bcf02027613b4caefdce8.jpg', 'test',
        '2023-02-02 19:52:38');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
VALUES (10, 5, 'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/b29672e25430abc8eb31daecda52b8cb.mp4',
        'https://tiktok-video-1313520634.cos.ap-beijing.myqcloud.com/b29672e25430abc8eb31daecda52b8cb.jpg', 'test',
        '2023-02-02 19:52:43');
INSERT INTO `tiktok`.`videos` (`id`, `author_id`, `play_url`, `cover_url`, `title`, `publish_time`)
